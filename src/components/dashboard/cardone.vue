      ...
      <v-row class=" px-2" no-gutters>
        ...
        <v-col md="5" class="mt-12 pt-3">
            <v-card-media class="pa-0 ma-0" >
                <v-img :src="SrcImg" position="bottom"></v-img>
            </v-card-media>
        </v-col>
        ...
        <!-- BUTTON CARD 1          -->
          ...
          <v-row no-gutters>
            <v-col md="5" class="ml-2 mr-4" >
                    ...
                    <v-btn block dense color="teal darken-4 " dark
                    class="body-2" router to="/ProsesBelajar">MULAI BELAJAR</v-btn>
                
            </v-col>
            <v-col md="5">
               
                    <v-btn block dense color="teal darken-2" dark
                    class="body-2" router to="/TestMAI">ULANGI TEST MAI</v-btn>
