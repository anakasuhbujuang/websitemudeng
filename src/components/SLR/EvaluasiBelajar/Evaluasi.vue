    ...
    <v-card color="white" width="auto" height="auto" class="pb-2" style="overflow-x:hidden; overflow-y:hidden;">
      ...
      <v-row justify="center" class="mt-8 " no-gutters>
        ...
        <v-col md="1" class="pl-1"> -->
          <!-- AXIOS<p class="subtitle-1 grey--text text--darken-3 font-weight-bold">{{evaluasiResult.nilai}}</p> -->
        ...
        <v-col md="3" class="pl-1"> -->
          <!-- AXIOS<p class="subtitle-1 grey--text text--darken-3 font-weight-bold">{{evaluasiResult.points}} pts</p> -->
      ...
      <v-row justify="center" no-gutters class="mb-4">
        <v-col md="11">
          <p class="body-2 text-center grey--text font-weight-regular">{{deskripsiEvaluasiResult[evaluasiResult].deskripsi}}</p>
        </v-col>
      </v-row>
  ...
  <v-dialog v-model="dialogHasilEvaluasi" persistent max-width="350px" > 
    <v-card color="white" width="auto" height="auto" class="pb-2" style="overflow-x:hidden; overflow-y:hidden;">
      ...
      <v-row no-gutters class="px-2">
        <v-col class="pr-1">
          <v-btn  block color="teal darken-4 white--text" 
          class="subtitle-2 font-weight-bold" @click="dialogHasilEvaluasi= false;" router to="/Dashboard">Selesai</v-btn>
        </v-col>
        <v-col>
          <v-btn block color="teal darken-2 white--text" 
