      ...
      <v-row justify="center" class="mb-2" >
        ...
        <v-dialog v-model="dialogHasilTestMAI" max-width="350px" > 
          ...
          class="pb-2" style="overflow-x:hidden; overflow-y:hidden;">
              ...
              <v-row  class="mt-4" no-gutters>
                <v-col  class="text-center">
                  <p class=" subtitle-1 grey--text text--darken-4 font-weight-bold">Kemampuan Metakognisi : 
                    <span class=" text-start red--text  text--accent-1 font-italic font-weight-bold">Low</span></p>
                </v-col>
              </v-row>       
              <v-row justify="center" no-gutters class="mt-2 mb-6">
                <v-col cols="10">
                  <p class="subtitle-2 text-center grey--text font-weight-regular" >
                    Kemampuan metakognisimu belum baik.<br>
            ...
            <div v-else-if="NilaiMAI <= PassingGradeMAIMedium">
              <v-card-media justify-center >
                <v-img  :src="SrcFighting"></v-img>
              </v-card-media>
              ...
              <v-row  class="mt-4" no-gutters>
                <v-col  class="text-center">
                  <p class=" subtitle-1 grey--text text--darken-4 font-weight-bold">Kemampuan Metakognisi : 
                    <span class=" text-start red--text  text--accent-1 font-italic font-weight-bold">Medium</span></p>
                </v-col>
              </v-row>       
              <v-row justify="center" no-gutters class="mt-2 mb-6">
                <v-col cols="10">
                  <p class="subtitle-2 text-center grey--text font-weight-regular" >
                    Kemampuan metakognisimu cukup baik.<br>
            ...
            <div v-else>
              ...
              <v-row  class="mt-4" no-gutters>
                <v-col  class="text-center">
                  <p class=" subtitle-1 grey--text text--darken-4 font-weight-bold">Kemampuan Metakognisi : 
                    <span class=" text-start red--text  text--accent-1 font-italic font-weight-bold">High</span></p>
                </v-col>
              </v-row>       
              <v-row justify="center" no-gutters class="mt-2 mb-6">
                <v-col cols="10">
                  <p class="subtitle-2 text-center grey--text font-weight-regular" >
                    Kemampuan metakognisimu sudah baik.<br>
            ...
            <v-row no-gutters class="px-2">
              <v-col class="pr-1">
                ...
                @click="dialogHasilTestMAI = false;" router to="/Dashboard"
                >Mulai Belajar</v-btn>
              </v-col>
            </v-row>
