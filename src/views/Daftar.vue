<template>
  <div style="background-color:#FAFAFA;" class="hidden-sm-and-down hidden-xl-only">
          ...
          <v-row justify="start" class="mt-2 ml-10 pl-12">
            <v-col md="9">
              <v-form ref="form" @submit.prevent="daftar" v-model="isValidDaftar" lazy-validation>
                ...
                class="mb-2" outlined required persistent-hint dense>
                </v-text-field>
                <v-text-field
                ...
                outlined required persistent-hint dense class="mb-2" >
                </v-text-field>
                <v-text-field            
                ...
                outlined required counter dense class="mb-2">
                </v-text-field>
              </v-form>
              ...
              block @click="Daftar()"> DAFTAR </v-btn>
    ...
    <v-dialog v-model="daftarFailed" max-width="400px">
      ...
      <v-card style="overflow-x:hidden;">
        ...
        <v-row class="px-4 pb-4" no-gutters>
          ...
          <v-col>
            ...
            class=" subtitle-2 font-weight-bold "
            block @click="closeDialogFailedDaftar()"> DAFTAR
            </v-btn>
          </v-col>
        </v-row>
      </v-card>
